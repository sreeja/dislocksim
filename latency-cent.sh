...
docker exec -it locker-tokyo tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.8 flowid 1:2
docker exec -it locker-tokyo tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.9 flowid 1:2
...
docker exec -it locker-singapore tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.8 flowid 1:2
docker exec -it locker-singapore tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.9 flowid 1:2
...
docker exec -it locker-capetown tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.7 flowid 1:2
docker exec -it locker-capetown tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.9 flowid 1:2
...
docker exec -it locker-newyork tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.7 flowid 1:2
docker exec -it locker-newyork tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.8 flowid 1:2
