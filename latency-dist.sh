...
docker exec -it locker-singapore tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.6 flowid 1:2
...
docker exec -it locker-capetown tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.6 flowid 1:2
docker exec -it locker-capetown tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.17 flowid 1:3
docker exec -it locker-capetown tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.7 flowid 1:3
...
docker exec -it locker-newyork tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.7 flowid 1:3
...
docker exec -it zoo-singapore tc qdisc add dev eth0 parent 1:2 handle 2: netem delay 38ms
...
docker exec -it zoo-singapore tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.6 flowid 1:2
...
docker exec -it zoo-capetown tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.6 flowid 1:2
docker exec -it zoo-capetown tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.17 flowid 1:3
docker exec -it zoo-capetown tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.7 flowid 1:3
...
docker exec -it zoo-newyork tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.20.0.7 flowid 1:3
